...
urlpatterns = patterns('messages.views',
                       ...
                       url(r'^project_search/(?P<search_context>.+)$', 'project_search', name='project_search'),
                       url(r'^attachment_search/(?P<search_context>.+)$', 'attachment_search', name='attachment_search'),
